...
public class AA4_WoodShops {
    ...
    public static void main(String[] args) {
        ...
        while (continuar) {
            ...
            System.out.println("5. Añadir nuevo cliente en WoodShops"); // Nueva opción
            System.out.println("6. Mostrar listado de todos los clientes"); // Nueva opción
            System.out.println("7. Añadir ticket de venta en la tienda"); // Nueva opción
            System.out.println("8. Mostrar un listado de resumen de tickets en la tienda"); // Nueva opción
            ...
            switch (opcion) {
                ...
                case 7:
                    ...
                    if (tiendaSeleccionadaVenta >= 1 && tiendaSeleccionadaVenta <= woodShop.getTiendas().size()) {
                        ...
                        double totalTicket = nuevoTicket.calcularTotal();
...
// Utiliza una lista auxiliar para almacenar las líneas de ticket ya impresas
                                ...
                                System.out.println("Total del Ticket: " + ticket.calcularTotal());
                                System.out.println("-----------------------------------------------");
